    ...
    >
      <Container>
        ...
        >
          ...
          <Nav>
            {/* Tautan menu logout */}
            {location.pathname !== "/login" && location.pathname !== "/register" && location.pathname !== "/comingsoon" ? (
              <NavLink
                to="/comingsoon"
                className="nav-link"
                style={{
            ...
            {/* Tautan menu logout */}
            {isUserLoggedIn && location.pathname !== "/login" && location.pathname !== "/register" && location.pathname !== "/comingsoon" ? (
              <Nav.Link
                onClick={doLogout}
                className="nav-link"
